                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr v-for="category in categories" :key="category.id" class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">
                                <span v-if="category.parent" class="bg-gray-100 px-2 py-0.5 rounded text-gray-700 text-xs">
                            ...
                            <td class="px-6 py-4">
                                <span 
                                    ...
                                    :class="category.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'"
                                >
                                    {{ category.status }}
                                </span>
                            </td>
